...
乳幼児期のスクリーン利用の量と使い方は、言語・コミュニケーション発達とどのように関連するか。

## Scope

- Population: 主に0〜6歳
- Exposure: television / video / smartphone / tablet / apps / other digital media
- Exposure dimensions:
  - quantity / duration
  - background exposure
  - content quality
...
- Secondary mechanism outcomes: adult words, child vocalizations, conversational turns
...
- C006: 言語・コミュニケーション発達の弱さが後のスクリーン時間増加につながる逆方向の関係もある
  - Status: SUPPORTED_BY_LONGITUDINAL_EVIDENCE

## Files

- `search-strategy.md`: 検索条件、anchor review、更新探索、制約
- `evidence-table.md`: 主要研究・ガイドラインの抽出表
